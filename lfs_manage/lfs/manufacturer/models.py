...
from lfs.cloud_storage.cloud_fields import CloudImageField
...
class Manufacturer(models.Model):
    ...
    image = CloudImageField(verbose_name=_(u"Image"), blank=True, null=True, upload_to="images", sizes=((60, 60), (100, 100), (200, 200), (400, 400)))
