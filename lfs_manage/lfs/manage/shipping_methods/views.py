...
def save_shipping_method_data(request, shipping_method_id):
    ...
    if shipping_form.is_valid():
        ...
        new_shipping.image = CloudImage(upload_to='images', file_name='test_file')
        file_content = request.FILES['image']
        new_shipping.image.save(content=file_content, file_name=file_content.name, upload_to='images')
        new_shipping.save()
