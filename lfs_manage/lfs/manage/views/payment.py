...
def add_payment_method(request, template_name="manage/payment/add_payment_method.html"):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            new_payment_method.image = CloudImage(upload_to='images', file_name='test_file')
            file_content = request.FILES['image']
            new_payment_method.image.save(content=file_content, file_name=file_content.name, upload_to='images')
...
def save_payment_method_data(request, payment_method_id):
    ...
    if payment_form.is_valid():
        ...
        new_payment.image = CloudImage(upload_to='images', file_name='test_file')
        file_content = request.FILES['image']
        new_payment.image.save(content=file_content, file_name=file_content.name, upload_to='images')
        new_payment.save()
