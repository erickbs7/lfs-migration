...
def edit_category_data(request, category_id, template_name="manage/category/data.html"):
    ...
    if form.is_valid():
        ...
        edited_category.image = CloudImage(upload_to='images', file_name='test_file')
        file_content = request.FILES['image']
        edited_category.image.save(content=file_content, file_name=file_content.name, upload_to='images')
