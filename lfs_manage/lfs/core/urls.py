...
from lfs.customer.urls import views as customer_views
from lfs.manage.views import dashboard as manage_views
...
urlpatterns = [
    ...
    url(r'^shop/$', views.shop_view, name="lfs_shop_view"),

    url(r'^$', customer_views.login, name="lfs_login_view"),

    # Manage
    url(r'^manage/$', manage_views.dashboard, name="lfs_manage_view"),
