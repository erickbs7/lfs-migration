...
class ImageWithThumbsFieldFile(ImageFieldFile):
    ...
    def save(self, name, content, save=True):
        print("Método Save de ImageWithThumbsFieldFile")
        # TODO: Refactoring point to enabled cloud storages services.
        super(ImageWithThumbsFieldFile, self).save(name, content, save)
        destination_blob = name

        # TODO: Remover Storage.
       # cloud_storage.save(content, name, destination_blob, content.content_type)
        ...
        if self.sizes:
            for size in self.sizes:
                ...
                # TODO: Refactoring point cloud storages services.
