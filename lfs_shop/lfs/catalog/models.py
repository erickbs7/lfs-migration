...
from lfs.cloud_storage.cloud_fields import CloudImageField, CloudImageCharField
...
class Category(models.Model):
    ...
    **Attributes:**
    ...
    # TODO: Refacoting point.
    image = CloudImageField(verbose_name=_(u"Image"), blank=True, null=True, upload_to="images", sizes=THUMBNAIL_SIZES)
...
class Image(models.Model):
    ...
    **Attributes:**
    ...
    #image = ImageWithThumbsField(_(u"Image"), upload_to="images", blank=True, null=True, sizes=THUMBNAIL_SIZES)
    image = CloudImageField(verbose_name=_(u"Image"), blank=True, null=True, upload_to="images",
